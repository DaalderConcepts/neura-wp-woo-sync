        ...
        <div class="wcmac-card wcmac-main-settings">
            ...
            <form method="post" action="">
                ...
                <p class="description" style="margin-bottom:12px;">
                    ...
                    <strong><a href="https://app.neuramerce.com/settings?tab=connectors" target="_blank">Neuramerce → Instellingen → Koppelingen</a></strong>.
                ...
                <table class="form-table">
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description">Te vinden in Neuramerce via <em>Instellingen → Koppelingen → WooCommerce</em></p>
                        </td>
                    </tr>
                    <tr>
                ...
                <table class="form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description">Te vinden in Neuramerce via <em>Voorraad → WooCommerce → Plugin Push Sync</em></p>
                        </td>
                    </tr>
                    <tr>
